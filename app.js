...
const STOCK_UNIVERSES = {
  ...
  RETAIL: [...new Set([
  'AAON','ABST','ACCD','ACCO','ACEL','ACHC','ACIC','ACLS','ACMR','ACNB',
  'ACNI','ACOR','ACPW','ACRS','ACRX','ACST','ACTG','ACTU','ACUN','ACUP',
  'ACUQ','ACVA','ADAP','ADAT','ADAW','ADAX','ADBE','ADBI','ADBN','ADBP',
  'ADCX','ADCY','ADCZ','ADDA','ADDE','ADDF','ADDG','ADDH','ADDI','ADDK',
  'ADDL','ADDM','ADDN','ADDO','ADDP','ADDQ','ADDR','ADDS','ADDT','ADDU',
  'ADDV','ADDW','ADDX','ADDY','ADDZ','ADEN','ADEP','ADER','ADES','ADET',
  'ADEX','ADEY','ADEZ','ADFG','ADFH','ADFI','ADFJ','ADFK','ADFL','ADFM',
  'ADFN','ADFO','ADFP','ADFQ','ADFR','ADFS','ADFT','ADFU','ADFV','ADFW',
  'ADFX','ADFY','ADFZ','ADGA','ADGB','ADGC','ADGD','ADGE','ADGF','ADGG',
  'ADGH','ADGI','ADGJ','ADGK','ADGL','ADGM','ADGN','ADGO','ADGP','ADGQ',
  'ADGR','ADGS','ADGT','ADGU','ADGV','ADGW','ADGX','ADGY','ADGZ','ADHA',
  'ADHB','ADHC','ADHD','ADHE','ADHF','ADHG','ADHH','ADHI','ADHJ','ADHK',
  'ADHL','ADHM','ADHN','ADHO','ADHP','ADHQ','ADHR','ADHS','ADHT','ADHU',
  'ADHV','ADHW','ADHX','ADHY','ADHZ','ADMA','ADNA','ADNT','ADUS','AEHR',
  'AEIS','AFCG','AFRM','AGAE','AGCO','AGFS','AGIO','AGRO','AGTI','AGYS',
  'AHCO','AHPI','AIMC','AINV','AIRC','AIRI','AIWS','AIXI','AJRD','AKAM',
  'AKBA','AKLI','AKRO','AKTS','AKYA','ALBT','ALCO','ALCX','ALEC','ALGM',
  'ALGT','ALHC','ALIM','ALIT','ALLK','ALLO','ALLT','ALNY','ALOT','ALPP',
  'ALRM','ALRN','ALSK','ALTG','ALTO','AMBA','AMBC','AMBO','AMC','AMCB',
  'AMCR','AMCX','AMEH','AMER','AMKR','AMLX','AMMO','AMNB','AMOB','AMOT',
  'AMPE','AMPH','AMPS','AMRN','AMRS','AMRX','AMSC','AMSWA','AMTB','AMTD',
  'AMTX','AMWL','ANF','ANGI','AOSL','APEI','APLD','APOG','APPF','APPN',
  'ARAY','ARCO','ARGO','ARHS','ARKO','ARKR','ARLO','AROW','ARQQ','ARQT',
  'ARTW','ARUN','ARVL','ARWR','ASAI','ASGN','ASLE','ASPI','ASPS','ASRT',
  'ASTE','ASTL','ASTX','ASXC','ATAI','ATCO','ATEC','ATEN','ATER','ATEX',
  'ATHM','ATIP','ATLC','ATMU','ATNI','ATRC','ATSG','ATUS','AUDC','AVAH',
  'AVAV','AVDX','AVEO','AVNS','AVNT','AVNW','AVST','AVXL','AXDX','AXGT',
  'AXLA','AXNX','AXON','AXSM','AXTA','AXTI','AYRO','AZEK','AZUL','AZYO',
  'BAND','BANF','BANR','BARK','BASE','BBSI','BBWI','BCOV','BCPC','BCRX',
  'BEAM','BECN','BEDU','BEKE','BELFA','BELFB','BFAM','BFH','BFIN','BFLY',
  'BFST','BGCP','BGFV','BHLB','BIGC','BILI','BILL','BIRD','BITF','BJDX',
  'BJRI','BKEN','BKFS','BKSY','BKTI','BKYI','BLBD','BLDE','BLDP','BLKB',
  'BLMN','BLNK','BMBL','BMEA','BMI','BMRA','BMRC','BMRN','BNED','BNFT',
  'BNGO','BOKF','BOOM','BOOT','BORR','BOX','BPFH','BPMC','BPOP','BPRN',
  'BPTH','BRBR','BRBS','BRCC','BRDG','BRDS','BRFS','BRID','BRMK','BROS',
  'BRPM','BRZE','BSAC','BSET','BSIG','BSQR','BSRR','BSTC','BSVN','BTAI',
  'BTBT','BTDR','BTMD','BTRS','BURL','BUSE','BWEN','BWFG','BWMX','BWXT',
  'BXMT','BYFC','BYND','BYON','BYSI','BZFD','BZUN','CAAS','CADE','CAKE',
  'CALX','CAMP','CAMT','CANG','CANO','CARA','CARG','CARS','CASH','CASS',
  'CATO','CATY','CAVA','CBAN','CBAY','CBFV','CBIO','CBMG','CBNK','CBRL',
  'CBSH','CBTX','CCAP','CCCS','CCNE','CCOI','CCRN','CCRT','CCSI','CCUR',
  'CCXI','CDEV','CDLX','CDNA','CEI','CELC','CELH','CELU','CENN','CERC',
  'CERT','CEVA','CFFI','CFLT','CFNB','CFRA','CFSB','CGBD','CGEM','CGNT',
  'CGNX','CHCO','CHCT','CHDN','CHEF','CHEK','CHFS','CHGG','CHKP','CHPT',
  'CHUY','CHWY','CIEN','CIFS','CLAR','CLBT','CLFD','CLNE','CLNV','CLOV',
  'CLPS','CLSK','CMBM','CMC','CMLS','CMPO','CNF','CNSL','CNXN','CODA',
  'COHU','COMP','CONN','COOK','CORZ','COTY','COUR','COVA','CPAI','CPAX',
  'CPRI','CPRX','CPSI','CPSS','CRAI','CRDF','CRDO','CRESY','CRMT','CRNT',
  'CROX','CRTO','CRUS','CRVO','CRVS','CRWD','CSGS','CSII','CSKI','CSPI',
  'CSTE','CSTR','CSV','CSWI','CTBI','CTHR','CTIC','CTLP','CTMX','CTOS',
  'CTRN','CTSO','CULP','CURO','CUTR','CVBF','CVCO','CVCY','CVGI','CVGW',
  'CVLG','CVNA','CWCO','CYBR','CZWI','DADA','DAVA','DAVE','DCBO','DCGO',
  'DCOM','DCRB','DCTH','DENN','DERM','DFFN','DFIN','DGII','DINE','DIOD',
  'DISCO','DISH','DJT','DKNG','DLHC','DLPN','DLTH','DM','DMAC','DMDV',
  'DMTK','DNAI','DNMR','DNTX','DNUT','DOCN','DOCS','DOCU','DOGZ','DOMA',
  'DOMH','DOMK','DOYU','DPRO','DPSI','DPTX','DQ','DRRX','DRS','DRVN',
  'DRWN','DRXL','DSSI','DTC','DTEA','DTIL','DTRM','DTSS','DTST','DUOL',
  'DUOS','DV','DVAX','DWAC','DWSN','DXPE','DXYN','DYAI','DYNS','DYNT',
  'DZSI','EAGL','EARN','EARS','EASY','EAT','EBAY','EBON','ECIA','ECOR',
  'ECPG','ECVT','EDAP','EDBL','EDCO','EDFU','EDGR','EDTK','EDUC','EEFT',
  'EGIO','EGLX','EGOV','EGRX','EH','EHTH','EKSO','ELEV','ELF','ELFD',
  'ELLO','ELMD','ELMO','ELON','ELOX','ELST','ELTK','ELVA','ELVN','ELVS',
  'ELVT','ELYS','EMCF','EMED','EMER','EMKR','EMMS','EMNT','EMOW','EMPL',
  'EMPS','ENAB','ENBP','ENCO','ENDO','ENER','ENFN','ENIB','ENOB','ENPH',
  'ENRT','ENTG','ENTV','ENVA','ENVB','ENVE','ENVI','ENVT','ENVX','ENVY',
  'ENZN','EOLS','EOSE','EPAZ','EPIC','EPIQ','EPIX','EPOW','EPRT','EPSN',
  'EPWK','EPWT','EQBK','EQFN','EQOS','EQRR','EQST','ERAS','ERIC','ERII',
  'ERIN','ERLY','ESAB','ESCA','ESGR','ESLA','ESNA','ESNT','ESOC','ESPR',
  'ESRT','ESSA','ESSC','ESTA','ESTC','ESTE','ESTR','ESXB','ETSY','ETTX',
  'ETWO','EVBG','EVER','EVERI','EVEX','EVFM','EVGO','EVIO','EVLO','EVLV',
  'EVMT','EVNN','EVOP','EVRI','EVRL','EVRO','EVRS','EVSB','EVSI','EVTC',
  'EWCZ','EXAS','EXEL','EXLS','EXNT','EXPC','EXPI','EXPR','EXPS','EXQR',
  'EXRX','EXTC','EXTD','EXTN','EXTR','EYEG','EYEN','EYES','EYPT','EZGO',
  'FARO','FAT','FATH','FBIZ','FBMS','FBRT','FCEL','FCFS','FCNCA','FCPT',
  'FCRD','FDBC','FDMT','FDUS','FEAT','FEIM','FELE','FENV','FEYE','FFAI',
  'FFBC','FFBH','FFBW','FFIC','FFIN','FFIV','FFLC','FFMR','FFNM','FFOR',
  'FFRM','FFWM','FGBI','FGCO','FGEN','FGNA','FGPR','FHBI','FHCO','FHLT',
  'FIGS','FIHL','FINB','FINV','FINW','FISI','FISR','FISS','FIVE','FIVN',
  'FIXX','FKWL','FLIC','FLMN','FLNC','FLNT','FLNX','FLWS','FLXS','FMAO',
  'FMBH','FMBK','FMCB','FMFG','FMNB','FMNC','FMST','FMTX','FND','FNKO',
  'FNLC','FNRN','FOCS','FOLD','FONR','FONV','FORC','FORM','FORR','FOSL',
  'FOUR','FOXF','FPAY','FPBI','FRAF','FRBK','FREQ','FREY','FREYR','FRGE',
  'FRHC','FRLA','FRMO','FROG','FRPH','FRPT','FRSB','FRSG','FRST','FRTX',
  'FRVA','FRXB','FSBC','FSBW','FSCO','FSFG','FSMB','FSR','FSRX','FSSI',
  'FSTR','FTDR','FTHM','FTNT','FTRE','FTSP','FUBO','FULL','FULT','FUMB',
  'FUNC','FUNO','FUSB','FUTU','FVAM','FVCB','FWAA','FWBI','FWRG','FXCO',
  'FXLV','FXNC','GABC','GAIN','GALT','GAMB','GANO','GASS','GATC','GATE',
  'GATS','GCAM','GCBC','GCEH','GCI','GCMG','GCPT','GCST','GDCL','GDOT',
  'GDRX','GDS','GECC','GEEX','GELS','GEMS','GENC','GENI','GENK','GENM',
  ...
  'GLNK','GLNV','GLOB','GLOP','GLPG','GLPI','GLRE','GLSI','GLTR','GLUE',
  'GLUX','GMBL','GNOG','GOEV','GOGL','GOOS','GOTU','GPAC','GPS','GRAB',
  'GREE','GRIN','GRPN','GRVY','GSAT','GSM','GTES','GTLB','GTLS','GTN',
  'HAFC','HASI','HAYW','HBI','HCAT','HEAR','HELE','HGV','HIBB','HIIQ',
  'HIMS','HIMX','HIPO','HIVE','HLLY','HLTH','HMHC','HMST','HNNA','HNRG',
  'HNST','HOFT','HOLI','HOLX','HOMB','HONE','HOOD','HOOK','HOPE','HOPU',
  'HOTT','HOUS','HPCO','HPKK','HPNN','HPVR','HRGE','HRMY','HROW','HRPK',
  'HRTG','HRTH','HRTS','HSAI','HSCS','HSDT','HSEN','HSIC','HSKI','HSON',
  'HSTM','HTBI','HTBK','HTGC','HTLD','HUT','HUYA','HVT','HYFM','HYLN',
  'HYZN','IART','IBCP','IBER','IBEX','IBIO','IBOC','ICAD','ICCC','ICCM',
  'ICCT','ICDI','ICFI','ICHR','ICLK','ICMB','ICNB','ICPT','ICUI','IDCC',
  ...
  'INVE','INVI','INVV','INVX','INVZ','INXN','INZY','IOAC','IOCS','IOFX',
  'IONQ','IOT','IOVA','IPAR','IPAX','IPDN','IPGP','IPIX','IPKW','IPRX',
  'IPSC','IPSN','IPVF','IPXX','IQ','IQBT','IQMD','IQMK','IQNX','IQRM',
  'IQST','IQVI','IRBT','IRCP','IRDM','IRDN','IREN','IRGT','IRGX','IRIX',
  'IRMD','IRNT','IROQ','IRTC','ITRI','ITRN','JACK','JAKK','JAMF','JBDI',
  'JJSF','JKHY','JMIA','JMU','JNPR','JOAN','JOUT','JRVR','JSMD','JUSH',
  'JUVA','JYNT','KALA','KALI','KALU','KC','KCSR','KELYA','KFRC','KGEI',
  'KGRN','KHOLY','KINS','KINZ','KIRK','KISN','KIWA','KLIC','KLNT','KLVT',
  'KMDA','KMPR','KNBE','KNDI','KNOP','KNSA','KNSL','KODK','KOSS','KPLT',
  'KPRX','KPTI','KRBP','KRMD','KRON','KROS','KRTX','KRUS','KSPI','KSPN',
  'KSTR','KTOS','KVHI','KVSA','KXIN','LAAC','LAC','LACQ','LADR','LAKE',
  'LALT','LASR','LAUR','LAWS','LAZR','LBAI','LBAY','LBIX','LBPH','LBPS',
  'LBRD','LBRDA','LBRDK','LBSR','LBTYA','LBTYK','LC','LCID','LCII','LCNB',
  'LCNW','LCUT','LDOS','LEGH','LENZ','LESL','LFAP','LFEN','LFGR','LFMD',
  'LFST','LFUS','LGF','LGIH','LGND','LGST','LGVN','LHDX','LI','LICY',
  'LIFT','LIFX','LILI','LILM','LIMAF','LINC','LINM','LION','LIQT','LITB',
  'LIVN','LIVO','LIVX','LIZI','LKFN','LLAP','LLIT','LLNW','LMND','LMNR',
  'LMPX','LNDC','LNKB','LNN','LNSR','LNTH','LOAN','LOCO','LOGI','LOMA',
  'LOPE','LORX','LOTZ','LOUP','LOVE','LPLA','LPRO','LQDA','LQDT','LRCX',
  'LRMR','LSAQ','LSCC','LSEA','LSEQ','LSPD','LSXMA','LTHM','LTRN','LTRY',
  'LULU','LUMN','LUNA','LURI','LVEX','LVLU','LVNS','LVOX','LVPB','LVVV',
  'LVWR','LWAY','LWLG','LXFN','LXNX','LXRX','LYRA','MAIA','MAKO','MAMS',
  'MANU','MAQC','MARA','MARK','MATW','MAXN','MAYS','MBCN','MBII','MBIO',
  'MBLY','MBRX','MBSC','MBVX','MCAA','MCAC','MCAF','MCBC','MCCF','MCRI',
  'MDB','MDJM','MDVX','MDXG','MED','MFGP','MFIN','MFLR','MFMS','MFNA',
  'MFNC','MFNX','MGNI','MGRC','MGRM','MGRX','MGTA','MGTI','MGTX','MIGI',
  'MIR','MKFG','MKSI','MLCO','MLKN','MMSI','MMYT','MNDO','MNDT','MNDY',
  'MNKD','MNMD','MNOV','MNPR','MNRD','MNRK','MNRO','MNSI','MNSN','MNTK',
  'MNTS','MNTV','MNVT','MNWN','MODG','MODN','MODV','MOGO','MOMO','MOV',
  'MPLN','MPWR','MRIN','MRVL','MSGE','MSRT','MTAL','MTCH','MTLS','MTSI',
  'MTTR','MX','MYSZ','NARI','NATH','NBIX','NCMI','NCTY','NDLS','NEGG',
  'NEOG','NERD','NERV','NESR','NETD','NETE','NEVI','NEVS','NEVT','NEWG',
  'NEWM','NEWP','NFBK','NFLX','NGVC','NKLA','NKTR','NLOK','NMIH','NNBR',
  'NNDM','NOMD','NOVA','NOVT','NRDS','NRXP','NSTG','NTAP','NTCT','NTES',
  'NTGR','NTST','NTWK','NVCR','NVEC','NVEE','NVEI','NVST','NWSA','NXPI',
  'NXPL','NXST','OLED','OLPX','OMCL','OMER','OMEX','OMGA','OMHL','OMIC',
  'ONAM','ONCE','ONCT','ONCX','ONEM','ONEW','ONFO','ONIT','ONMD','ONNT',
  'ONOA','ONON','ONOV','ONTO','OOMA','OPAD','OPBK','OPCH','OPCO','OPEN',
  'OPFI','OPRA','OPRX','OSIS','OTRK','OUST','OWL','OWLET','PAGS','PANW',
  'PARA','PARR','PATI','PAYA','PAYX','PBPB','PCOR','PCTI','PDCE','PDD',
  'PDFS','PEGA','PEGY','PEMB','PENB','PENG','PENM','PENN','PENR','PENS',
  'PENX','PEPH','PERC','PERI','PERW','PESI','PETN','PETS','PETZ','PFBC',
  'PFBI','PFBQ','PFBS','PFBT','PFBV','PFBW','PFCB','PFCC','PFCD','PFCE',
  'PFCF','PFCG','PFCH','PFCI','PFCJ','PFCK','PFCL','PFCM','PFCN','PFCO',
  'PFCP','PFIS','PFIX','PFLT','PFNX','PHVS','PLAB','PLAY','PLBY','PLCE',
  'PLMR','PLNA','PLNF','PLNG','PLNH','PLNI','PLNJ','PLNK','PLNL','PLNM',
  'PLNN','PLNO','PLNP','PLNQ','PLNR','PLNS','PLNT','PLNU','PLNV','PLNW',
  'PLNX','PLNY','PLNZ','PLTK','PLTR','PLUG','PLXS','PNTG','PNTM','POWI',
  'PRAA','PRCT','PRFT','PRGS','PRGX','PROG','PRPL','PRTS','PRVA','PSFE',
  'PTEN','PTLO','PTON','PTRA','PZZA','QCRH','QFIN','QLYS','QNST','QRVO',
  'RAMP','RCAT','RCBI','RCBK','RCII','RCM','RCMT','RCON','RDFN','RDWR',
  'REAL','REED','REGI','RELY','RENT','RERE','REVG','RFIL','RGP','RIDE',
  'RIOT','RIVN','RKT','RLAY','RMBL','RMBS','RMCF','ROKU','ROOT','RRGB',
  'RSKD','RUTH','RVLV','RXRX','SAFE','SBGI','SBLK','SCSC','SCVL','SCWX',
  'SDIG','SEAC','SEAT','SEER','SELB','SFNC','SFT','SFUN','SGHC','SHAK',
  'SHEN','SIFY','SILC','SILK','SILV','SIMO','SIRI','SITM','SKIN','SKLZ',
  'SKX','SLAB','SLB','SLCA','SLI','SLQT','SMAR','SMCI','SMIT','SMPL',
  'SMTC','SNAX','SNBR','SNCE','SNCR','SNDA','SNEX','SNOA','SNOW','SNPS',
  'SNRH','SNSE','SOFI','SOLO','SPAI','SPGI','SPLK','SPOK','SPPI','SPRB',
  'SPRC','SPRO','SPRT','SPRU','SQSP','SRCE','SSP','STAA','STAG','STBA',
  'STCN','STEM','STFS','STGW','STIM','STIX','STJM','STKS','STLD','STNE',
  'STNG','STRM','STRS','STRT','STRW','STWO','STXB','STXS','STYD','STZA',
  'SUNW','SVMK','SWKS','SWVL','SYBT','SYNA','SYNH','SYRS','TALK','TANH',
  'TBLA','TCBI','TCJH','TDOC','TDUP','TELA','TENB','TGTX','THWX','TIGR',
  'TILE','TISI','TKLF','TKNO','TLIS','TLND','TLYS','TMCI','TMDI','TME',
  'TNDM','TPIC','TPR','TREX','TRIP','TRIT','TRMR','TRNC','TRNS','TROO',
  'TRVG','TSEM','TTCF','TTMI','TTWO','TUEM','TUFN','TUYA','TWI','TWLO',
  'TWST','TXMD','TXRH','TZOO','UA','UAMY','UBER','UCTT','UDMY','UEIC',
  'UEPS','UFCS','UFPI','UGRO','ULTA','ULTI','UMBF','UMC','UMRX','UNFI',
  'UNIT','UNTY','UPLD','UPST','UPTS','UPWK','URBN','UROS','URRN','VCYT',
  'VEEV','VERA','VERB','VERL','VERS','VERT','VERV','VERY','VEST','VETX',
  'VFC','VFFB','VGFC','VIAC','VIAO','VIAP','VIAR','VIAV','VICR','VIPS',
  'VIST','VITL','VJET','VLDR','VNDA','VNET','VOXX','VRM','VRNS','VRNT',
  'VSCO','VSLR','VSTO','VTEX','VVPR','W','WAL','WB','WEAV','WEN',
  'WGMI','WINA','WING','WINT','WIRE','WKHS','WOLF','WOOF','WPRT','WRLD',
  'WTTR','WULF','XCUR','XELB','XFOR','XIN','XMTR','XNCR','XOMA','XPEL',
...
// (HEALTHCARE/ENERGY/TECH/RETAIL/BROAD), which is also how category is threaded
// into scoreStock() — see "How category is stored" note at the Macro Overlay call
// site. RETAIL currently mirrors TECH's values as a placeholder until its universe
// is verified and its own macro sensitivity is characterized.
const MACRO_ADJUSTMENTS = {
  RISK_OFF:                { HEALTHCARE: -20, ENERGY: -15, TECH: -20, RETAIL: -20, BROAD: -20 },
  GEOPOLITICAL:            { HEALTHCARE: -10, ENERGY:  10, TECH: -15, RETAIL: -15, BROAD: -10 },
  TECH_ROTATION_OUT:       { HEALTHCARE:  -5, ENERGY:  10, TECH: -20, RETAIL: -20, BROAD:  -5 },
  BROAD_RALLY:             { HEALTHCARE:  10, ENERGY:   5, TECH:  10, RETAIL:  10, BROAD:  10 },
  MOMENTUM_DAY:            { HEALTHCARE:   5, ENERGY:   0, TECH:  15, RETAIL:  15, BROAD:   5 },
  SECTOR_WEAKNESS_BIOTECH: { HEALTHCARE: -15, ENERGY:   0, TECH:   0, RETAIL:   0, BROAD:  -5 },
  SECTOR_WEAKNESS_ENERGY:  { HEALTHCARE:   0, ENERGY: -15, TECH:   0, RETAIL:   0, BROAD:  -5 },
  SECTOR_WEAKNESS_TECH:    { HEALTHCARE:   0, ENERGY:   0, TECH: -15, RETAIL: -15, BROAD:  -5 },
  CHOPPY:                  { HEALTHCARE:   0, ENERGY:   0, TECH:   0, RETAIL:   0, BROAD:   0 },
};
...
function getSectorETFForCategory(category) {
  ...
  return { HEALTHCARE: 'XBI', ENERGY: 'XLE', TECH: 'XLK', RETAIL: 'XLY' }[category] || null;
}
...
function renderFilterButtons() {
  ...
  const universes = ['HEALTHCARE','ENERGY','TECH','RETAIL','BROAD'];
  return `
    ...
    <div class="settings-section mt12">
      ...
      <div class="settings-row">
        <div>
          ...
          <div class="settings-hint">HEALTHCARE ${STOCK_UNIVERSES.HEALTHCARE.length} · ENERGY ${STOCK_UNIVERSES.ENERGY.length} · TECH ${STOCK_UNIVERSES.TECH.length} · RETAIL ${STOCK_UNIVERSES.RETAIL.length} · BROAD ${STOCK_UNIVERSES.BROAD.length}</div>
        </div>
      </div>
      <div class="settings-row">
        <div>
